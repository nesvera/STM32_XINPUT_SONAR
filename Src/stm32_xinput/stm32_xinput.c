...
void updateSticks(){
	...
	int32_t sonar_distance_in = Sonar_Read();
	
	int16_t sonar_distance_out = (int16_t)map(sonar_distance_in, 550, 3350, INT16_MIN, INT16_MAX );  
	
	XINPUT_stickUpdate(STICK_LEFT, sonar_distance_out, yLeftStickValue);
